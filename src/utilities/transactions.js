...
export const categorizeTransactionByDescription = function(transaction) {
  ...
  else if (Description.match(/DisneyPlus 888-9057888 CA/i))  categorizedTransactionData = {Category: "Disney+ subscription", DescriptionDisplay: "Disney+ subscription", Notes: null};
  ...
  else if (Description.match(/(?:Sams ?Club #\d+ \w+ \w{2}|Sams Club #\d+ \d{3}-\d{3}-\d{4} SC)/i)) categorizedTransactionData = {Category: "Groceries/Necessities", DescriptionDisplay: "Sam's Club", Notes: null};
  ...
  else if (Description.match(/Azteca Mexican Restaur Mauldin SC/i))  categorizedTransactionData = {Category: "Family Outings", DescriptionDisplay: "Azteca Mexican Restaurant", Notes: null};
  ...
  else if (Description.match(/Viva Villa Mexican Duncan SC/i))  categorizedTransactionData = {Category: "Family Outings", DescriptionDisplay: "Viva Villa Mexican Grill", Notes: null};
  else if (Description.match(/Monterrey Mexican Rest \w+ \w{2}/i))  categorizedTransactionData = {Category: "Family Outings", DescriptionDisplay: "Monterrey Mexican Restaurant", Notes: null};
  ...
  else if (Description.match(/TST\* Kannika s Thai Ki Greenville SC/i))  categorizedTransactionData = {Category: "Family Outings", DescriptionDisplay: "Kannika's Thai Kitchen", Notes: null};
  ...
  else if (Description.match(/Cicis Pizza \w+ \w{2}/i))  categorizedTransactionData = {Category: "Family Outings", DescriptionDisplay: "Cicis Pizza", Notes: null};
  ...
  else if (Description.match(/Carrabbas \d+ \w+ \w{2}/i))  categorizedTransactionData = {Category: "Family Outings", DescriptionDisplay: "Carrabba's", Notes: null};
  ...
  else if (Description.match(/SQ \*Little River (?:Roast|Coffe) Spartanburg SC/i))  categorizedTransactionData = {Category: "Family Outings", DescriptionDisplay: "Little River Roasting Co.", Notes: null};
  ...
  else if (Description.match(/Clock of Lyman Restaur Lyman SC/i))  categorizedTransactionData = {Category: "Family Outings", DescriptionDisplay: "Clock Restaurant of Lyman", Notes: null};
  ...
  else if (Description.match(/Auntie Anne s #\w+ \w+ \w{2}/i))  categorizedTransactionData = {Category: "Family Outings", DescriptionDisplay: "Auntie Anne's", Notes: null};
  ...
  else if (Description.match(/(?:AMAZON\.COM|AMZN MKTP US)\*\w+(?: A)? AMZN\.COM[\/ ]BILL ?WA/i))  categorizedTransactionData = {Category: "Miscellaneous", DescriptionDisplay: "Amazon", Notes: null};
