...
export const categorizeTransactionByDescription = function(transaction) {
  ...
  else if (Description.match(/(?:Sams ?Club #\d+ \w+ \w{2}|Sams Club #8142 864-574-3480 SC)/i)) categorizedTransactionData = {Category: "Groceries/Necessities", DescriptionDisplay: "Sam's Club", Notes: null};
  ...
  else if (Description.match(/SQ \*Little River Roast Spartanburg SC/i))  categorizedTransactionData = {Category: "Family Outings", DescriptionDisplay: "Little River Roasting Co.", Notes: null};
